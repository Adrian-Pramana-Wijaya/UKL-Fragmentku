...
import com.example.ukl_fragmentku.adapter.MyFriendAdapter
import com.example.ukl_fragmentku.database.AppDatabase
import com.example.ukl_fragmentku.database.MyFriendsDao
...
class MyFriendsFragment : Fragment() {
    ...
    private fun initView() {
        ...
        fab_btn?.setOnClickListener {
            (activity as MainActivity2).tampilMyFriendsAddFragment()
        }
        ambilDataTeman()
